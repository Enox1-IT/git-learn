locals {
  ...
  rg_name    = terraform.workspace == "default" ? "${var.rg_name}" : "${var.rg_name}-${terraform.workspace_suffix}"
  sa_name    = terraform.workspace == "default" ? "${var.sa_name}" : "${var.sa_name}-${terraform.workspace_suffix}"
